...
class AlertServer(alert_pb2_grpc.AlertTypeControllerServicer):
    async def UpdateAlertTypeSchedule(self, request: alert_pb2.AlertTypeScheduleRequest,
    ...
    async def ListAlertTypeSchedule(self, request: alert_pb2.ListAlertTypeScheduleRequest,
                                    context: grpc.aio.ServicerContext):
